...
| 実機 iPhone `iPhone16 Ultra Pro Max` | free team signing build PASS、install PASS、devicectl launch PASS。実機 XCUITest は `.ui-tests.xctrunner` provisioning 未作成で停止 |
| 実機 iPad `Thinkpad` | free team signing build PASS、install PASS、devicectl launch PASS。実機 XCUITest は `.ui-tests.xctrunner` provisioning 未作成で停止 |
