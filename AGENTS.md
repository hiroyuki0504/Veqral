...
- `codex/handover-package-20260623`: `docs/handover/` に引き継ぎパッケージを追加。2026-06-23 に MacHost build/test、17 Host smokes、iOS Simulator/Mac Catalyst/Watch Simulator build、live `/v1/health`、LaunchAgent、GitHub PR/Issue state を確認。機能コード変更なし。README など既存 docs の drift は `docs/handover/18-documentation-drift.md` に分離して記録。
...
13. Handover package follow-up: `docs/handover/17-next-actions.md` の順で、README drift 修正、iPhone/iPad 実機 5 項目、#A7 cross-vendor 再実行、Host deploy/rollback 手順の明文化を進める。未確認事項は `docs/handover/14-open-questions.md` に集約済み。
