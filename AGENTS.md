...
2. 差別化バックログ（継続）: #A5 認証オンボーディング・ウィザードが次の未完了項目。
   - #A0/#A1/#A2/#A3 は Draft PR 済み。#A4 は `codex/a4-portfolio-real-data` で実装済み、Draft PR 化と検証完了後に次へ進む。
